...
public class JFrameConsultaMulta extends javax.swing.JFrame {
    ...
    public JFrameConsultaMulta( boolean select, boolean disconnectOnClose, Multa multa, Usuario leitor, boolean alterarAdiconar ) throws SQLException {
        initComponents();
    ...
    private void setQuery() {
        ...
        this.query = "SELECT multas.codigo_multa as ID, multas.valor as Valor, multas.data_pagamento as DataPagamento, multas.status as Status, usuarios.nome_completo as Usuário, emprestimos.codigo_emprestimo as IdEmpréstimo FROM multas LEFT JOIN usuarios ON multas.codigo_usuario = usuarios.codigo_usuario LEFT JOIN emprestimos ON multas.codigo_emprestimo = emprestimos.codigo_emprestimo";
        
        if( leitor != null ) {
            this.query += " WHERE multas.codigo_usuario = " + leitor.getCodigoUsuario();
        }
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        try {
            ...
            jFrameCRUD = new JFrameMultaCRUD( null, false );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            try {
                ...
                JFrameMultaCRUD jFrameCRUD;
                jFrameCRUD = new JFrameMultaCRUD( multa, false );
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.multa.setCodigoMulta(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaMulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaMulta( false, true, null, null, true).setVisible(true);
                } catch ( Exception ex ) {
                    LogTrack.getInstance().addException( ex, true, null );
                }
            }
