...
public class JFrameConsultaEmprestimo extends javax.swing.JFrame {
    ...
    public JFrameConsultaEmprestimo( boolean select, boolean disconnectOnClose, Emprestimo emprestimo, Usuario leitor, boolean alterarAdiconar ) throws SQLException {
        initComponents();
    ...
    private void setQuery() {
        ...
        this.query = "SELECT emprestimos.codigo_emprestimo as ID, emprestimos.data_emprestimo as DataEmpréstimo, emprestimos.data_devolucao_prevista as DataDevoluçãoPrevista, usuarios.nome_completo as Usuário, exemplares.codigo_exemplar as IDExemplar FROM emprestimos LEFT JOIN usuarios ON emprestimos.codigo_usuario = usuarios.codigo_usuario LEFT JOIN exemplares ON emprestimos.codigo_exemplar = exemplares.codigo_exemplar";
    
        if( leitor != null ) {
            this.query += " WHERE emprestimos.codigo_usuario = " + leitor.getCodigoUsuario();
        }
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        try {
            ...
            jFrameCRUD = new JFrameEmprestimoCRUD( null, false );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            emprestimo.setCodigoEmprestimo(codigo);
            ...
            try {
                ...
                JFrameEmprestimoCRUD jFrameCRUD;
                jFrameCRUD = new JFrameEmprestimoCRUD( emprestimo, false );
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.emprestimo.setCodigoEmprestimo(codigo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaEmprestimo( false, true, null, null, true).setVisible(true);
                } catch ( Exception ex ) {
                    LogTrack.getInstance().addException( ex, true, null );
                }
            }
