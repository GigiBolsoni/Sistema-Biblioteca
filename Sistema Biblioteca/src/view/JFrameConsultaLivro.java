...
public class JFrameConsultaLivro extends javax.swing.JFrame {
    ...
    private String query = "SELECT livros.codigo_livro as ID, livros.titulo as Titulo, livros.classificacao_etaria as Classificação, autores.nome_completo as Autor, editoras.nome as Editora, generos.nome as Gênero FROM livros LEFT JOIN autores ON autores.codigo_autor = livros.codigo_autor LEFT JOIN editoras ON editoras.codigo_editora = livros.codigo_editora LEFT JOIN generos ON generos.codigo_genero = livros.codigo_genero ORDER BY ID";

    
    private ResultSetTableModel result;   
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaLivro( boolean select, boolean disconnectOnClose, Livro livro, boolean alterarAdiconar ) throws SQLException {
        initComponents();
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        try {
            ...
            jFrameCRUD = new JFrameLivroCRUD( null, false );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            try {
                ...
                JFrameLivroCRUD jFrameCRUD;
                jFrameCRUD = new JFrameLivroCRUD( livro, false );
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.livro.setCodigoLivro(codigo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaLivro( false, true, null, true).setVisible(true);
                } catch ( Exception ex ) {
                    LogTrack.getInstance().addException( ex, true, null );
                }
            }
