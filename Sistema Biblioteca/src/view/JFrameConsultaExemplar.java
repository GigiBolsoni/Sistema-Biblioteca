...
public class JFrameConsultaExemplar extends javax.swing.JFrame {
    ...
    public JFrameConsultaExemplar( boolean select, boolean disconnectOnClose, Exemplar exemplar, Usuario leitor, boolean alterarAdiconar ) throws SQLException {
        initComponents();
    ...
    private void setQuery() {
        ...
        this.query = "SELECT exemplares.codigo_exemplar as ID, exemplares.status as Status, livros.titulo as Título FROM exemplares LEFT JOIN livros ON exemplares.codigo_livro = livros.codigo_livro";
    
        if( leitor != null ) {
            this.query += " WHERE exemplares.status = 'Disponível' ";
        }
    ...
    private void initComponents() {
        ...
        setTitle("Consulta de Exemplares");
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        try {
            ...
            jFrameCRUD = new JFrameExemplarCRUD( null, false );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            try {
                ...
                JFrameExemplarCRUD jFrameCRUD;
                jFrameCRUD = new JFrameExemplarCRUD( exemplar, false );
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.exemplar.setCodigoExemplar(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaExemplar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaExemplar( false, true, null, null, true).setVisible(true);
                } catch ( Exception ex ) {
                    LogTrack.getInstance().addException( ex, true, null );
                }
            }
