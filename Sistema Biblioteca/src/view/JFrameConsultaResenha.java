...
public class JFrameConsultaResenha extends javax.swing.JFrame {
    ...
    public JFrameConsultaResenha( boolean select, boolean disconnectOnClose, Resenha resenha, Usuario leitor, boolean adicionar ) throws SQLException {
        initComponents();
        
        this.adicionar = adicionar;
        
        jButtonAdicionar.setEnabled(this.adicionar);
    ...
    private void setQuery() {
        ...
        this.query = "SELECT resenhas.codigo_resenha as ID, resenhas.avaliacao as Avaliação, usuarios.nome_completo as Usuário, livros.titulo as TítuloDoLivro FROM resenhas LEFT JOIN usuarios ON resenhas.codigo_usuario = usuarios.codigo_usuario LEFT JOIN livros ON resenhas.codigo_livro = livros.codigo_livro";
    
        if( leitor != null ) {
            this.query += " WHERE resenhas.codigo_usuario = " + leitor.getCodigoUsuario();
        }
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        try {
            ...
            jFrameCRUD = new JFrameResenhaCRUD( null, false );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            resenha.setCodigoResenha(codigo);
            ...
            try {
                ...
                JFrameResenhaCRUD jFrameCRUD;
                jFrameCRUD = new JFrameResenhaCRUD( resenha, false );
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.resenha.setCodigoResenha(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaResenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaResenha( false, true, null, null, true).setVisible(true);
                } catch ( Exception ex ) {
                    LogTrack.getInstance().addException( ex, true, null );
                }
            }
