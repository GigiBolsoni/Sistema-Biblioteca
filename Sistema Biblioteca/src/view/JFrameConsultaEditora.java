...
public class JFrameConsultaEditora extends javax.swing.JFrame {
    
    private Editora editora;
    private boolean select;
    private boolean disconnectOnClose;
    
    private String query = "SELECT codigo_editora as ID, nome as Nome, cnpj as CNPJ, website as Site FROM editoras";
    
    private ResultSetTableModel result;   
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaEditora(boolean select, boolean disconnectOnClose, Editora editora) throws SQLException {
        initComponents();
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        try {
            ...
            jFrameCRUD = new JFrameEditoraCRUD( null, false );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            try {
                ...
                JFrameEditoraCRUD jFrameCRUD;
                jFrameCRUD = new JFrameEditoraCRUD( editora, false );
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.editora.setCodigoEditora(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaEditora( false, true, null ).setVisible(true);
                } catch ( Exception ex ) {
                    LogTrack.getInstance().addException( ex, true, null );
                }
            }
